...
class PDFPlayer : public ds::ui::IPdf {
  public:
	...
	/** Returns the number of pages in this document. PDF's are 1-indexed, so the number returned from this function can
	 * be set as the last page */
	...
	virtual void showLinks() override;
	virtual void hideLinks() override;
