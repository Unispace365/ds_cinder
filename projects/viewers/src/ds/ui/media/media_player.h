...
public:
	...
	void					setMediaSizeChangedCallback(std::function<void(const ci::Vec2f& newSize)> func){ mMediaSizeChangedCallback = func; }
...
protected:
	...
	std::function<void(const ci::Vec2f&)>		mMediaSizeChangedCallback;
