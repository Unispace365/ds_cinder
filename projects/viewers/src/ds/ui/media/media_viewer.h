...
/**
 * \class MediaViewer
 *			This is MediaPlayer in a BasePanel: plays the typical media types (Web / PDF / Video / Stream / Image) in a
 *moveable/sizeable/bounds-checked panel.
 */
class MediaViewer : public BasePanel {
  public:
	...
	/// unloads any media and interface already loaded. initialize could be called again after this and load the
	/// same content
	void uninitialize();
