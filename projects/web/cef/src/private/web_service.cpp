...
WebCefService::WebCefService(ds::Engine& e)
  : ds::AutoUpdate(e, AutoUpdateType::SERVER | AutoUpdateType::CLIENT) {
	...
	mEngine.registerSpritePropertySetter(
		"web_url", [](ds::ui::Sprite& bs, const std::string& theValue, const std::string& fileReferrer) {
...
void WebCefService::start() {
	...
	*/
	...
	auto log_dir = ci::app::Platform::get()->getExecutablePath().generic_string() + "/cef/";
	...
	const std::string logPath	= ds::Environment::expand("%LOCAL%/cache/browser_log.log");
