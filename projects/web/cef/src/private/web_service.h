...
class WebCefService : public ds::EngineService, public ds::AutoUpdate {
  public:
	...
	// charcter)
	void sendKeyEvent(const int browserId, const int state, int windows_key_code, char character, const bool shiftDown,
					  const bool cntrlDown, const bool altDown, const bool isCharacter);
