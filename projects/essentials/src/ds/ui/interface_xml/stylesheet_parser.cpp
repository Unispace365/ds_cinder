...
BOOST_FUSION_ADAPT_STRUCT(ds::ui::stylesheets::IdSelector, (std::string, selector))

BOOST_FUSION_ADAPT_STRUCT(ds::ui::stylesheets::ClassSelector, (std::string, selector))

BOOST_FUSION_ADAPT_STRUCT(ds::ui::stylesheets::Property, (std::string, property_name)(std::string, property_value))

BOOST_FUSION_ADAPT_STRUCT(ds::ui::stylesheets::Rule, (std::vector<std::vector<ds::ui::stylesheets::Selector>>,
													  matchers)(std::vector<ds::ui::stylesheets::Property>, properties))

BOOST_FUSION_ADAPT_STRUCT(ds::ui::Stylesheet, (std::vector<ds::ui::stylesheets::Rule>, mRules))
...
namespace ds { namespace ui {
	namespace stylesheets {
		...
		struct stylesheet_grammar : qi::grammar<Iterator, Rules(), Skipper> {
			...
			qi::rule<Iterator, std::vector<Selector>(), Skipper> selectors;
		...
		template bool parse_stylesheet<boost::spirit::istream_iterator>(boost::spirit::istream_iterator first,
																		boost::spirit::istream_iterator last, Rules& s);
		template bool parse_stylesheet<std::string::const_iterator>(std::string::const_iterator first,
																	std::string::const_iterator last, Rules& s);
