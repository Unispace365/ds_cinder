...
namespace ds { namespace debug {
	...
	void Automator::activate() {
		...
		if (mWatermark) {
			...
			// TODO
			// 		const std::wstring automatedText = L"Automated Mode | Automated Mode | Automated Mode | Automated Mode
			// | Automated Mode | Automated Mode | Automated Mode | Automated Mode | Automated Mode | Automated Mode |
			// Automated Mode | Automated Mode | Automated Mode"; 		mWatermark = mEngine.addTextSprite(automatedText,
			// mWatermarkFontResourceId, 72); 		mWatermark->disable(); 		mWatermark->setPosition(72, 0);
	...
	std::shared_ptr<BaseAction> Automator::Factory::addAction(std::vector<int>& freeList, ds::ui::SpriteEngine& engine,
