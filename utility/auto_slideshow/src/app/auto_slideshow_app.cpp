...
auto_slideshow_app::auto_slideshow_app()
	: ds::App()
...
void auto_slideshow_app::setupServer(){
	// add sprites
...
void auto_slideshow_app::fileDrop(ci::app::FileDropEvent event){
...
CINDER_APP(downstream::auto_slideshow_app, ci::app::RendererGl(ci::app::RendererGl::Options().msaa(4)),
