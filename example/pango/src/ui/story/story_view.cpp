...
void StoryView::randomizeText() {
	...
	mPangoText->callAfterDelay([this] { randomizeText(); }, 5.0f);
}
...
void StoryView::onUpdateServer(const ds::UpdateParams& p) {
	...
	if (mPangoText && mMessage) {
		...
		std::string theText =
			...
			"Hello, world "
			"Here's a <span font='HelveticaNeueLT Std Cn Bold'>bunch more text</span> to simulate a lot of the more "
			"text that the other option had for a <span font='HelveticaNeueLT Std Lt Light'>lot more</span> of the "
			"text and stuff and this sentence has a lot of and's and other and's and other things of that nature and "
			"such. "
			...
			//"hovedgruppen fra <i>forskjellige</i> <span font_family='Noto Sans'>destinasjoner. Tilknytningsbillett er
			//gyldig inntil 24 timer fr avreise hovedgruppe. </span> \n\nUnicef said 3m" " people had been affected and
			//more than <i>1,400</i> had been killed. <b>The government</b> said some 27,000 people remained "
			"trapped "
			//"and awaiting <s>help.</s> <sub>Here's some very small text.</sub>"
			//" This is great<sup>2</sup>"
			//" <span size='xx-large'>HOORAY</span>"
			//" The <span font_family='Charter ITC Pro' weight='400' foreground='#3f2f10'>Presidential Election</span>
			//is a <span weight='bold'>Farce</span>"
