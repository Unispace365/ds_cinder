#ifndef _CIRCLECROPEXAMPLE_APP_UI_TABLE_UTIL_SPRITECACHE_H_
#define _CIRCLECROPEXAMPLE_APP_UI_TABLE_UTIL_SPRITECACHE_H_
...
#endif // !_CIRCLECROPEXAMPLE_APP_UI_TABLE_UTIL_SPRITECACHE_H_
