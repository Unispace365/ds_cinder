#ifndef _CIRCLECROPEXAMPLE_APP_UI_TOUCH_VIEWDRAGGER_H_
#define _CIRCLECROPEXAMPLE_APP_UI_TOUCH_VIEWDRAGGER_H_
...
#endif //!_CIRCLECROPEXAMPLE_APP_UI_TOUCH_VIEWDRAGGER_H_