...
void layout_example::setupServer() {
	...
	horizontalLayout->setProcessTouchCallback(
		[this, horizontalLayout](ds::ui::Sprite* bs, const ds::ui::TouchInfo& ti) {
	...
	ds::ui::XmlImporter::loadXMLto(&rootSprite, ds::Environment::expand("%APP%/data/layouts/layout_view.xml"),
								   spriteMap);
	...
	ds::ui::XmlImporter::loadXMLto(&rootSprite, ds::Environment::expand("%APP%/data/layouts/layout_alignments.xml"),
								   spriteMapTwo);
	...
	sl->listenToEvents<IdleStartedEvent>(
		[sl](const IdleStartedEvent& e) { sl->setSpriteText("event_text", "Idling!"); });
	sl->listenToEvents<IdleEndedEvent>(
		[sl](const IdleEndedEvent& e) { sl->setSpriteText("event_text", "Not Idling!"); });
