#ifndef _SIMPLEVIDEOPLAYER_APP_UI_TOUCH_VIEWDRAGGER_H_
#define _SIMPLEVIDEOPLAYER_APP_UI_TOUCH_VIEWDRAGGER_H_
...
#endif //!_SIMPLEVIDEOPLAYER_APP_UI_TOUCH_VIEWDRAGGER_H_