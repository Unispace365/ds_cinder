#pragma once
#ifndef _PHYSICS_EXAMPLE_APP_QUERY_QUERYHANDLER_H_
#define _PHYSICS_EXAMPLE_APP_QUERY_QUERYHANDLER_H_
...
#endif // !_PHYSICS_EXAMPLE_APP_QUERY_QUERYHANDLER_H_
