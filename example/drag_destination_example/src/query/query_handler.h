#ifndef _DRAG_DESTINATION_EXAMPLE_APP_QUERY_QUERYHANDLER_H_
#define _DRAG_DESTINATION_EXAMPLE_APP_QUERY_QUERYHANDLER_H_
...
#endif // !_DRAG_DESTINATION_EXAMPLE_APP_QUERY_QUERYHANDLER_H_