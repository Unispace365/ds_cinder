...
void drag_destination_example::update() {
	inherited::update();
...
void drag_destination_example::mouseDown(ci::app::MouseEvent e) {
	mTouchDebug.mouseDown(e);
}

void drag_destination_example::mouseDrag(ci::app::MouseEvent e) {
	mTouchDebug.mouseDrag(e);
}

void drag_destination_example::mouseUp(ci::app::MouseEvent e) {
	mTouchDebug.mouseUp(e);
}

void drag_destination_example::fileDrop(ci::app::FileDropEvent event){
...
CINDER_APP_BASIC(example::drag_destination_example, ci::app::RendererGl(ci::app::RendererGl::AA_MSAA_4))