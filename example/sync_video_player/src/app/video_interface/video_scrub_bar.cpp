...
VideoScrubBar::VideoScrubBar(Globals& g, const float widdyWamWamWozzle)
  ...
  , mRemoved(false) {
	...
	mBall = new ds::ui::Image(mEngine, ds::Environment::expand("%APP%/data/images/ui/video_scrub_ball.png"),
							  ds::ui::Image::IMG_CACHE_F | ds::ui::Image::IMG_PRELOAD_F);
	addChild(*mBall);
	...
	mHome = new ds::ui::ImageButton(mEngine, "%APP%/data/images/ui/video_scrbu_home.png",
									"%APP%/data/images/ui/video_scrbu_home.png", 20.0f);
	addChildPtr(mHome);
	mHome->setCenter(0.0f, 0.5f);
	mHome->setPosition(-homeX, getHeight() / 2.0f);

	mPauseOff = new ds::ui::ImageButton(mEngine, "%APP%/data/images/ui/video_scrbu_pause_off.png",
										"%APP%/data/images/ui/video_scrbu_pause_off.png", 20.0f);
	...
	mPauseOn = new ds::ui::ImageButton(mEngine, "%APP%/data/images/ui/video_scrbu_pause_on.png",
									   "%APP%/data/images/ui/video_scrbu_pause_on.png", 20.0f);
	...
	mVolumeOn = new ds::ui::ImageButton(mEngine, "%APP%/data/images/ui/video_scrbu_volume_on.png",
										"%APP%/data/images/ui/video_scrbu_volume_on.png", 20.0f);
	addChildPtr(mVolumeOn);
	mVolumeOn->setCenter(0.0f, 0.5f);
	mVolumeOn->setPosition(widdyWamWamWozzle + volumeX, getHeight() / 2.0f);

	mVolumeOff = new ds::ui::ImageButton(mEngine, "%APP%/data/images/ui/video_scrbu_volume_off.png",
										 "%APP%/data/images/ui/video_scrbu_volume_off.png", 20.0f);
