...
void PanoramicVideo::setupServer() {
	...
	//"%APP%/data/images/menu/exit_app_glow.png", [this](ci::vec3){ std::exit(0); }));
	...
	menuItemModels.push_back(ds::ui::TouchMenu::MenuItemModel(
		L"Show Video List", "%APP%/data/images/menu/pinboard_normal.png", "%APP%/data/images/menu/pinboard_glow.png",
		[this](ci::vec3 p) { mEngine.getNotifier().notify(RequestVideoList(p)); }));
