...
void StoryQuery::query(AllData& output) {
	...
	//									0			1				2				3				4				5					6
	//7
	std::string recyQuery = "SELECT resourcesid, "
							"resourcestype,resourcesduration,resourceswidth,resourcesheight,resourcesfilename,"
							"resourcespath,resourcesthumbid FROM Resources";
