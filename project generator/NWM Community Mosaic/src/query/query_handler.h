#pragma once
#ifndef _NWM COMMUNITY MOSAIC_APP_QUERY_QUERYHANDLER_H_
#define _NWM COMMUNITY MOSAIC_APP_QUERY_QUERYHANDLER_H_
...
#endif // !_NWM COMMUNITY MOSAIC_APP_QUERY_QUERYHANDLER_H_