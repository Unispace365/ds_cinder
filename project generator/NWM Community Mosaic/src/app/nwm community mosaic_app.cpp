#include "nwm community mosaic_app.h"
...
NWM Community Mosaic::NWM Community Mosaic()
	: ds::App(ds::RootList()
...
void NWM Community Mosaic::setupServer(){
...
void NWM Community Mosaic::update() {
	ds::App::update();
...
void NWM Community Mosaic::forceStartIdleMode(){
...
void NWM Community Mosaic::onAppEvent(const ds::Event& in_e){
	if(in_e.mWhat == RequestAppExitEvent::WHAT()){
		quit();
	} 
}

void NWM Community Mosaic::keyDown(ci::app::KeyEvent event){
...
void NWM Community Mosaic::mouseDown(ci::app::MouseEvent e) {
	mTouchDebug.mouseDown(e);
}

void NWM Community Mosaic::mouseDrag(ci::app::MouseEvent e) {
	mTouchDebug.mouseDrag(e);
}

void NWM Community Mosaic::mouseUp(ci::app::MouseEvent e) {
	mTouchDebug.mouseUp(e);
}

void NWM Community Mosaic::fileDrop(ci::app::FileDropEvent event){
...
CINDER_APP_BASIC(nwm::NWM Community Mosaic, ci::app::RendererGl(ci::app::RendererGl::AA_MSAA_4))