#ifndef _NWM COMMUNITY MOSAIC_APP_H_
#define _NWM COMMUNITY MOSAIC_APP_H_
...
class NWM Community Mosaic : public ds::App {
public:
	NWM Community Mosaic();
...
#endif // !_NWM COMMUNITY MOSAIC_APP_H_