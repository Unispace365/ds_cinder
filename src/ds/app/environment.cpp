...
bool Environment::initialize() {
	...
	/// Also if the user sets up windows with OneDrive, the documents directory will be USER/OneDrive/Documents instead
	/// of USER/Documents This should account for that
#ifdef CINDER_MSW
...
std::string Environment::getLocalFile(const std::string& category, const bool includeProjectPath,
