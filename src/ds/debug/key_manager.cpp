...
namespace ds { namespace keys {
	...
	std::string KeyManager::keyCodeToString(const int keyCode) {
		...
		case KeyEvent::KEY_SPACE:
			return "space";
		case KeyEvent::KEY_EXCLAIM:
			return "!";
		case KeyEvent::KEY_QUOTEDBL:
			return "\"";
		case KeyEvent::KEY_HASH:
			return "#";
		...
		case KeyEvent::KEY_QUOTE:
			return "'";
		case KeyEvent::KEY_LEFTPAREN:
			return "(";
		case KeyEvent::KEY_RIGHTPAREN:
			return ")";
		...
		case KeyEvent::KEY_LSUPER:
			return "lsuper windows"; /* Left "Windows" case KeyEvent::KEY */
		case KeyEvent::KEY_RSUPER:
			return "rsuper windows"; /* Right "Windows" case KeyEvent::KEY */
		case KeyEvent::KEY_MODE:
			return "mode"; /* "Alt Gr" case KeyEvent::KEY */
		case KeyEvent::KEY_COMPOSE:
			return "compose"; /* Multi-case KeyEvent::KEY compose case KeyEvent::KEY */
		...
		case KeyEvent::KEY_POWER:
			return "power"; /* Power Macintosh power case KeyEvent::KEY */
		case KeyEvent::KEY_EURO:
			return "euro"; /* Some european case KeyEvent::KEYboards */
		case KeyEvent::KEY_UNDO:
			return "undo"; /* Atari case KeyEvent::KEYboard has Undo */
		default:
			break;
		}
		return "Unknown";
