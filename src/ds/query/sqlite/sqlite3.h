...
*/
int sqlite3session_create(sqlite3*			db,		  /* Database handle */
...
*/
void sqlite3session_table_filter(sqlite3_session* pSession,		  /* Session object */
...
*/
int sqlite3session_changeset(sqlite3_session* pSession,	   /* Session object */
...
*/
int sqlite3session_patchset(sqlite3_session* pSession,	 /* Session object */
...
*/
int sqlite3changeset_start(sqlite3_changeset_iter** pp,			/* OUT: New changeset iterator handle */
...
*/
int sqlite3changeset_op(sqlite3_changeset_iter* pIter,	   /* Iterator object */
...
** above.
*/
int sqlite3changeset_pk(sqlite3_changeset_iter* pIter, /* Iterator object */
...
*/
int sqlite3changeset_old(sqlite3_changeset_iter* pIter,	 /* Changeset iterator */
...
** is returned and *ppValue is set to NULL.
*/
int sqlite3changeset_new(sqlite3_changeset_iter* pIter,	 /* Changeset iterator */
						 int					 iVal,	 /* Column number */
...
** is returned and *ppValue is set to NULL.
*/
int sqlite3changeset_conflict(sqlite3_changeset_iter* pIter,  /* Changeset iterator */
							  int					  iVal,	  /* Column number */
...
*/
int sqlite3changeset_fk_conflicts(sqlite3_changeset_iter* pIter, /* Changeset iterator */
...
*/
int sqlite3changeset_concat(int	   nA,	  /* Number of bytes in buffer pA */
...
*/
int sqlite3changegroup_output(sqlite3_changegroup*, int* pnData, /* OUT: Size of output buffer in bytes */
...
*/
int sqlite3changeset_apply(sqlite3* db,						/* Apply change to "main" db of this handle */
...
*/
int sqlite3changeset_apply_strm(sqlite3* db, /* Apply change to "main" db of this handle */
...
int sqlite3changeset_invert_strm(int (*xInput)(void* pIn, void* pData, int* pnData), void*		 pIn,
								 int (*xOutput)(void* pOut, const void* pData, int nData), void* pOut);
int sqlite3changeset_start_strm(sqlite3_changeset_iter** pp, int (*xInput)(void* pIn, void* pData, int* pnData),
								void*					 pIn);
int sqlite3session_changeset_strm(sqlite3_session* pSession, int (*xOutput)(void* pOut, const void* pData, int nData),
								  void*			   pOut);
int sqlite3session_patchset_strm(sqlite3_session* pSession, int (*xOutput)(void* pOut, const void* pData, int nData),
								 void*			  pOut);
int sqlite3changegroup_add_strm(sqlite3_changegroup*, int (*xInput)(void* pIn, void* pData, int* pnData), void* pIn);
int sqlite3changegroup_output_strm(sqlite3_changegroup*, int (*xOutput)(void* pOut, const void* pData, int nData),
								   void* pOut);
