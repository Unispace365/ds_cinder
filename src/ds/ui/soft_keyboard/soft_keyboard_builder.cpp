...
namespace ds { namespace ui { namespace SoftKeyboardBuilder {
	...
	SoftKeyboard* buildUppercaseKeyboard(ds::ui::SpriteEngine& engine, SoftKeyboardSettings& settings,
										 ds::ui::Sprite* parent, bool numbers) {
		SoftKeyboard* newKeyboard = new SoftKeyboard(engine, settings);
	...
	ds::ui::SoftKeyboard* buildExtendedKeyboard(ds::ui::SpriteEngine& engine, SoftKeyboardSettings& settings,
												ds::ui::Sprite* parent /*= nullptr*/) {
	...
	ds::ui::SoftKeyboard* buildFullKeyboard(ds::ui::SpriteEngine& engine, SoftKeyboardSettings& settings,
											ds::ui::Sprite* parent /*= nullptr*/) {
	...
	SoftKeyboard* buildSimplifiedKeyboard(ds::ui::SpriteEngine& engine, SoftKeyboardSettings& settings,
										  ds::ui::Sprite* parent) {
		SoftKeyboard* newKeyboard = new SoftKeyboard(engine, settings);

		float xp	   = settings.mKeyInitialPosition.x;
		float yp	   = settings.mKeyInitialPosition.y;
		float btnWidth = makeAButton(engine, newKeyboard, xp, yp, L"q", L"Q", SoftKeyboardDefs::kLetter)->getWidth();
		makeAButton(engine, newKeyboard, xp, yp, L"w", L"W", SoftKeyboardDefs::kLetter);
		makeAButton(engine, newKeyboard, xp, yp, L"e", L"E", SoftKeyboardDefs::kLetter);
		makeAButton(engine, newKeyboard, xp, yp, L"r", L"R", SoftKeyboardDefs::kLetter);
		makeAButton(engine, newKeyboard, xp, yp, L"t", L"T", SoftKeyboardDefs::kLetter);
		...
		newKeyboard->setSize(10 * btnWidth, yp);
		newKeyboard->setScale(settings.mKeyScale);
	...
	SoftKeyboard* buildPinPadKeyboard(ds::ui::SpriteEngine& engine, SoftKeyboardSettings& settings,
									  ds::ui::Sprite* parent) {
		SoftKeyboard* newKeyboard = new SoftKeyboard(engine, settings);
	...
	ds::ui::SoftKeyboard* buildPinCodeKeyboard(ds::ui::SpriteEngine& engine, SoftKeyboardSettings& settings,
											   ds::ui::Sprite* parent /*= nullptr*/) {
		SoftKeyboard* newKeyboard = new SoftKeyboard(engine, settings);
	...
	SoftKeyboardButton* makeAButton(ds::ui::SpriteEngine& engine, SoftKeyboard* newKeyboard, float& xp, float& yp,
									const std::wstring& character, const std::wstring& characterHigh,
									const SoftKeyboardDefs::KeyType keyType) {
		SoftKeyboardButton* kb =
			new SoftKeyboardButton(engine, character, characterHigh, keyType, newKeyboard->getSoftKeyboardSettings());
...
}}} // namespace ds::ui::SoftKeyboardBuilder
