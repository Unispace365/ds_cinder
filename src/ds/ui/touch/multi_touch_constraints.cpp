...
ds::BitMask MULTITOUCH_CAN_POSITION_ = newUniqueBitMask();
ds::BitMask MULTITOUCH_NO_CONSTRAINTS_ = newUniqueBitMask();
...
const BitMask &MULTITOUCH_CAN_ROTATE = MULTITOUCH_CAN_ROTATE;
const BitMask &MULTITOUCH_CAN_POSITION_X = MULTITOUCH_CAN_POSITION_X_;
const BitMask &MULTITOUCH_CAN_POSITION_Y = MULTITOUCH_CAN_POSITION_Y;
