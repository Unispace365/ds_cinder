...
namespace ds { namespace ui {
	...
	class ControlCheckBox : public ds::ui::Sprite {
	  public:
		/// Make a checkbox with a light grey border and x. Automatically sizes to 50x50, change the size of this sprite
		/// to control the box size (the height is used for box size calculation)
