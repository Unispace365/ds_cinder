...
class Image : public Sprite {
  public:
	...
	/// Uses a shader to crop this image to a circle. By default, uses the bounds of the image for the circle (could
	/// be an oval) If you use your own shader for this sprite, the circle crop won't work
  ...
  protected:
	...
	/// \brief override this if you override isLoaded() and there are additional resources to load after isLoaded()
	/// returns true
