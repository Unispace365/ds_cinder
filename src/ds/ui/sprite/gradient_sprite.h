...
namespace ds { namespace ui {
	...
	class Gradient : public ds::ui::Sprite {
	  public:
		...
		*/
		static Gradient& makeH(SpriteEngine& engine, const ci::ColorA& left, const ci::ColorA& right,
		...
		\param parent A sprite for the new gradient to be added to after construction for convenience.
		*/
		static Gradient& makeV(SpriteEngine& engine, const ci::ColorA& top, const ci::ColorA& bottom,
							   Sprite* parent = nullptr);
		...
		*/
		Gradient(ds::ui::SpriteEngine& engine, const ci::ColorA& tlColor = ci::ColorA(1.0f, 1.0f, 1.0f, 1.0f),
		...
		*/
		...
		\param blColor The bottom left color for the 4-color gradient
		*/
		void setColorsAll(const ci::ColorA& tlColor, const ci::ColorA& trColor, const ci::ColorA& brColor,
		...
		void tweenColorsAll(const ci::ColorA& tlColor, const ci::ColorA& trColor, const ci::ColorA& brColor,
							const ci::ColorA& blColor, const float duration, const float delay = 0.0f,
							ci::EaseFn easeFunction = ci::easeNone, const std::function<void(void)>& finishFn = nullptr,
