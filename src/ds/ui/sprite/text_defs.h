...
namespace ds { namespace ui {
	...
	namespace Alignment {
		enum Enum { kLeft, kRight, kCenter, kJustify };
	...
	struct TextStyle {
		...
		TextStyle(const std::string& font, const std::string& configName, const double size, const double leading,
				  const double letterSpacing, const ci::ColorA&,
				  const ds::ui::Alignment::Enum& = ds::ui::Alignment::kLeft);
		...
		/// "name:Default; font:Arial; size:20; color:white; letter_spacing:0.0; leading:1.0; fit_font_size_range:12,
		/// 36; fit_font_sizes:12, 24, 27, 30, 36; align:center"
		...
		static std::string settingFromTextStyle(ds::ui::SpriteEngine& engine, TextStyle& theStyle,
												const bool includeName = false);
