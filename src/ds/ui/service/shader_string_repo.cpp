...
namespace ds::ui {
std::shared_ptr<ShaderStringRepository> ShaderStringRepository::mDefaultRepo = std::shared_ptr<ShaderStringRepository>();

ShaderStringRepository::ShaderStringRepository()
{
}

std::shared_ptr<ShaderStringRepository> ShaderStringRepository::setDefaultRepository(std::shared_ptr<ShaderStringRepository>& repo)
{
...
{
	if (std::find(mIncludeDirectories.begin(), mIncludeDirectories.end(), includeDirectory) == mIncludeDirectories.end()) {
