...
/// Read a colour from a string of the format
/// \code \#rrggbb, xrrggbb or rrggbb. For example: \#ffcc00. \endcode
/// Returns black if the color can't be parsed
ci::Color parse_color(const std::string& input);

/// Read a colour from a string of the format
/// \code \#rrggbb, xrrggbb or rrggbb. For example: \#ffcc00. \endcode
/// Returns the defaultColor if the string can't be found.
ci::Color parse_color(const std::string& input, const ci::Color& defaultColor);

/// Read a colour from a string of the format \code \#rrggbbaa, xrrggbbaa or rrggbbaa. For example: \#ffcc0033. \endcode
/// Returns black if the color can't be parsed
ci::ColorA parse_colora(const std::string& input);

/// Read a colour from a string of the format
/// \code \#rrggbbaa, xrrggbbaa or rrggbbaa. For example: \#ffcc0033. \endcode
/// Returns the defaultColor if the string can't be found.
ci::ColorA parse_colora(const std::string& input, const ci::ColorA& defaultColor);


/// Returns a string of the format
/// \code \#AARRGGBB from a ci::Color \endcode
...
/// Straight-up string to ci::ColorA conversion, Color format: \#AARRGGBB OR \#RRGGBB OR AARRGGBB OR RRGGBB. Example:
/// ff0033 or \#9933ffbb
ci::ColorA parseHexColor(const std::string& color);
/// Checks engine named colors, then does a string convert if it's not found. Color format: \#AARRGGBB OR \#RRGGBB OR
/// AARRGGBB OR RRGGBB. Example: ff0033 or \#9933ffbb
...
/// Returns the name of an engine color if the color matches one, or a string of the format \code \#AARRGGBB from a
/// ci::Color  \endcode
