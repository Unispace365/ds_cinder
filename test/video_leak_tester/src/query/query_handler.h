#pragma once
#ifndef _VIDEO_LEAK_TESTER_APP_QUERY_QUERYHANDLER_H_
#define _VIDEO_LEAK_TESTER_APP_QUERY_QUERYHANDLER_H_
...
#endif // !_VIDEO_LEAK_TESTER_APP_QUERY_QUERYHANDLER_H_
